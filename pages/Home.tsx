...
export const Home: React.FC = () => {
  return (
    <main className="flex-grow flex items-center justify-center relative px-6 lg:px-12 py-12 lg:py-0 min-h-[calc(100vh-80px)]">
        {/* Background Blobs */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
            ...
            {/* SVG Lines */}
            <svg className="absolute -right-20 top-1/4 h-[600px] w-auto opacity-10 text-text-main" fill="none" viewBox="0 0 200 400" xmlns="http://www.w3.org/2000/svg">
             ...
             <svg className="absolute -left-10 bottom-0 h-[400px] w-auto opacity-10 text-text-main transform rotate-12" fill="none" viewBox="0 0 200 400" xmlns="http://www.w3.org/2000/svg">
                <path d="M100 400 C120 300 80 150 100 50" stroke="currentColor" strokeWidth="2"></path>
                <ellipse cx="100" cy="50" rx="20" ry="40" stroke="currentColor" strokeWidth="1.5"></ellipse>
            </svg>
        </div>

        <div className="layout-content-container max-w-[1280px] w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
            {/* Text Content */}
            <div className="lg:col-span-5 flex flex-col gap-8 order-2 lg:order-1 text-center lg:text-left">
                <div className="space-y-4">
                    <span className="inline-block text-primary font-medium tracking-[0.2em] text-xs uppercase animate-fadeIn">Spring Collection '24</span>
                    <h1 className="text-text-main text-5xl sm:text-6xl xl:text-7xl font-serif font-light leading-[1.1] text-shadow-soft">
                        Woven from <br/>
                        <span className="italic font-normal text-primary">the Earth</span>
                    </h1>
                    <p className="text-text-main/80 text-lg leading-relaxed max-w-md mx-auto lg:mx-0 font-light">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 lg:justify-start justify-center pt-4">
                    ...
                    <Link to="/editorial" className="flex items-center gap-3 px-6 py-4 text-text-main font-medium hover:text-primary transition-colors group">
            ...
            <div className="lg:col-span-7 relative order-1 lg:order-2 flex justify-center lg:justify-end">
                <div className="absolute top-10 right-10 w-[80%] h-[90%] border border-primary/20 rounded-t-full rounded-b-[200px] transform rotate-3 z-0"></div>
                <div className="relative w-full max-w-[600px] aspect-[3/4] rounded-t-full rounded-b-[10rem] overflow-hidden shadow-2xl shadow-[#6B3E2D]/20 z-10 group cursor-pointer">
                    <div className="absolute inset-0 bg-black/10 group-hover:bg-transparent transition-colors duration-500 z-10"></div>
                    <img 
                        alt="Model in earth-toned linen clothing looking serene" 
